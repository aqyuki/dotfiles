# Generated by Powerlevel10k configuration wizard on 2023-10-09 at 09:55 JST.
...
# 2 lines, dotted, right frame, lightest-ornaments, sparse, few icons, fluent,
...
() {
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=66
